...
СТРОГОЕ ПРАВИЛО — НИКОГДА НЕ ВЫДУМЫВАЙ ЦИФРЫ:
- Если данных нет в базе — прямо говори "нет данных" или "недостаточно данных"
- Дистанс и буфер есть только у новых сделок (начиная с апреля 2026), для старых эти поля пустые — НЕ придумывай их
...
Отвечай на том языке на котором спрашивают. Будь честным и точным."""
